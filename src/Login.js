...
function Login() {
 ...
 const mockUsers = [
  { username: 'admin', password: 'admin123', email: 'admin@cnu.edu', unit: 'Regattas', role: 'admin' },
  ...
  { username: 'bistroUser', password: 'bistro123', email: 'bistro@cnu.edu', unit: 'Bistro', role: 'dining' }
];
